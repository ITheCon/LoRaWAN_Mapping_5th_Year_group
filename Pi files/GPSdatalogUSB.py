...
while True: 
        ...
        # store data in list
        data = [str(now),str(GPIO.input(PIN_1)),str(GPIO.input(PIN_2)),str(GPIO.input(PIN_3)),str(GPIO.input(PIN_4)),str(GPIO.input(PIN_5)),str(GPIO.input(PIN_6)),str(GPIO.input(PIN_7)),str(GPIO.input(PIN_8))]
